...
<body>
    <div class="container">
        <div class="card">
            ...
            <p>Your Java Web Application has been successfully compiled, packaged, containerized, and deployed by the Jenkins CI/CD pipeline onto a Docker container running Tomcat.</p>
